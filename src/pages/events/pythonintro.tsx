  ...
  return (
    <div className="container mx-auto p-8">
      <h1 className="text-4xl font-bold mb-6 text-center ">
        AI Club Meeting - March 6th - Python and AI Intro
      </h1>

      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">Lab Demonstration</h2>
        <p className="mb-4">
          During the meeting, a lab demonstration was shown by the AI club
          members.
        </p>
      </section>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">
          Experienced Members&apos; Discussion
        </h2>
        <p className="mb-4">
          The more experienced members broke out into teams to discuss long-term
          projects that involve AI in various fields.
        </p>
      </section>
  ...
  return (
    <div className="container mx-auto p-8 mt-4 border-2 border-black">
      ...
      <section className="mb-6">
        ...
        <p className="mb-4">
          You can print text to the console using the <code>print</code>{" "}
          function:
        </p>
        ...
        <p className="mb-4">
          Functions allow you to encapsulate code for reuse. Here&apos;s an
        ...
        <p className="mb-4">
          Variables store data values. Here&apos;s how you can define and use
          variables:
        </p>
        <pre className="bg-gray-100 p-4 rounded mb-6">
          <code>{`name = "AI Club"\nprint(name)`}</code>
        ...
        <p className="mb-4">
          Loops allow you to execute a block of code multiple times. Here&apos;s
        ...
        <p className="mb-4">
          Lists store multiple items in a single variable. Here&apos;s how you
          can define and use lists:
        </p>
        <pre className="bg-gray-100 p-4 rounded mb-6">
        ...
        <p className="mb-4">
          Now it&apos;s your turn, try to build something yourself.
        </p>
      </section>
    </div>
  );
