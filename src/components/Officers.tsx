...
const officers: Officer[] = [
  ...
  { name: "Julian Garcia", position: "Treasurer", major: "Aerospace Eng", hometown: "Wichita Falls, TX", image: "/julian.png", bio: " Julian is eager to merge aerospace & AI for tech innovation. Excited to grow the club, tackle projects, and explore AIs impact on aerospace."},
